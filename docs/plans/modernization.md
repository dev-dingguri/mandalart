...
| T12: MUI + Emotion 완전 제거 | :x: 미완료 | — |
| T13: Firebase SDK v12 | :white_check_mark: 완료 | `b46fcaa` |
| T14: usehooks-ts 제거 | :x: 미완료 | — |
| T15: Vitest 테스트 도입 | :x: 미완료 | — |
| T16: React 19 | :x: 미완료 (T1~T15 선행) | — |
| T17: 번들 최적화 + 최종 점검 | :x: 미완료 (T16 선행) | — |
| B1: 프리뷰 채널 로그인 실패 | :warning: 분석 완료, 수정 보류 | `16cf5f2` |
| B2: 확대 뷰 센터링 미동작 | :x: 미착수 | — |

**다음 작업 후보:** T12 (MUI 제거) → App.tsx의 ThemeProvider, theme.ts 삭제, 패키지 제거
