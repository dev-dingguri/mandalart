...
const GuidePage = () => {
  ...
  const ohtaniElements = t('guide.ohtani.elements', {
    returnObjects: true,
  }) as string[];
  const ohtaniLuckActions = t('guide.ohtani.luckActions', {
    returnObjects: true,
  }) as string[];

  const APPLICATIONS = Array.from({ length: 4 }, (_, i) => ({
    category: t(`guide.applications.${i}.category`),
    items: t(`guide.applications.${i}.items`, {
      returnObjects: true,
    }) as string[],
  }));
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-12" aria-labelledby="section-history">
          ...
          <div className="space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>
              {
                t('guide.history.paragraph1', { year: 1987 }).split(
                  t('guide.history.paragraph1Strong'),
                )[0]
              }
            ...
            <p>
              ...
              <strong className="text-foreground">
                {t('guide.history.paragraph2Strong')}
              </strong>
              {t('guide.history.paragraph2Suffix')}
            </p>
            <p>{t('guide.history.paragraph3')}</p>
          </div>
        </section>
        ...
        <section className="mb-12" aria-labelledby="section-structure">
          ...
          <div className="space-y-4 text-base leading-relaxed text-muted-foreground mb-6">
            <p>
              {
                t('guide.structure.intro').split(
                  t('guide.structure.introStrong'),
                )[0]
              }
              <strong className="text-foreground">
                {t('guide.structure.introStrong')}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div className="p-5 rounded-xl bg-primary/5 border border-primary/20 text-center">
              <div className="text-3xl font-bold text-primary mb-1">
                {t('guide.structure.card0.count')}
              </div>
              <div className="text-sm font-semibold text-foreground mb-1">
                {t('guide.structure.card0.label')}
              </div>
              <div className="text-xs text-muted-foreground">
                {t('guide.structure.card0.description')}
              </div>
            </div>
            <div className="p-5 rounded-xl bg-card border border-border text-center">
              <div className="text-3xl font-bold text-foreground mb-1">
                {t('guide.structure.card1.count')}
              </div>
              <div className="text-sm font-semibold text-foreground mb-1">
                {t('guide.structure.card1.label')}
              </div>
              <div className="text-xs text-muted-foreground">
                {t('guide.structure.card1.description')}
              </div>
            </div>
            <div className="p-5 rounded-xl bg-card border border-border text-center">
              <div className="text-3xl font-bold text-foreground mb-1">
                {t('guide.structure.card2.count')}
              </div>
              <div className="text-sm font-semibold text-foreground mb-1">
                {t('guide.structure.card2.label')}
              </div>
              <div className="text-xs text-muted-foreground">
                {t('guide.structure.card2.description')}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 text-base leading-relaxed text-muted-foreground">
            <p>
              <strong className="text-foreground">
                {t('guide.structure.centerMatrixStrong')}
              </strong>{' '}
              {t('guide.structure.centerMatrix')}
            </p>
            <p>
              <strong className="text-foreground">
                {t('guide.structure.outerMatrixStrong')}
              </strong>{' '}
              {t('guide.structure.outerMatrix')}
            </p>
            <p>
              {t('guide.structure.summary')}{' '}
              <strong className="text-foreground">
                {t('guide.structure.summaryStrong')}
              </strong>
              ...
              <thead>
                <tr className="bg-muted/50">
                  <th className="text-left px-4 py-3 font-semibold text-foreground whitespace-nowrap">
                    {t('guide.comparisonTable.headers.method')}
                  </th>
                  <th className="text-left px-4 py-3 font-semibold text-foreground whitespace-nowrap">
                    {t('guide.comparisonTable.headers.structure')}
                  </th>
                  <th className="text-center px-4 py-3 font-semibold text-foreground whitespace-nowrap">
                    {t('guide.comparisonTable.headers.specificity')}
                  </th>
                  <th className="text-center px-4 py-3 font-semibold text-foreground whitespace-nowrap">
                    {t('guide.comparisonTable.headers.overview')}
                  </th>
                  <th className="text-center px-4 py-3 font-semibold text-foreground whitespace-nowrap">
                    {t('guide.comparisonTable.headers.difficulty')}
                  </th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="mb-12" aria-labelledby="section-ohtani">
          ...
          <p className="mt-5 text-base leading-relaxed text-muted-foreground">
            ...
            <strong className="text-foreground">
              {t('guide.ohtani.conclusionStrong')}
            </strong>
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">{t('guide.cta.title')}</p>
          <Link
            to={`/${lang}${PATH_APP}`}
            className={buttonVariants({
